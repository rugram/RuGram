...
public class EmojiView extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    private int[] icons = {
            ...
            R.drawable.ic_patriotic_selector,
    ...
    public EmojiView(boolean needStickers, Context context) {
        ...
        for (int i = 0; i < Emoji.data.length; i++) {
            ...
            if (i == Emoji.GAY_NUMBER) {
                emojiGridAdapter = new EmojiGridAdapter(Emoji.noGayData);
            } else  if (i == 1) {
                emojiGridAdapter = new EmojiGridAdapter(Emoji.patrioticEmojiCharsNoSaw);
            } else {
                emojiGridAdapter = new EmojiGridAdapter(Emoji.data[i]);
            }
        ...
        if (showStickers) {
            ...
            scrollSlidingTabStrip.setDelegate(new ScrollSlidingTabStrip.ScrollSlidingTabStripDelegate() {
                ...
                public void onPageSelected(int page) {
                    ...
                    views.get(7).setSelection(stickersGridAdapter.getPositionForPack(stickerSets.get(index)));
                }
            });
